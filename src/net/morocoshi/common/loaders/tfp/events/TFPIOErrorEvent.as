package net.morocoshi.common.loaders.tfp.events 
{
	 ...
	 * @author tencho
	 */
	public class TFPIOErrorEvent extends IOErrorEvent implements ITFPFileErrorEvent 
	{
		...
		public function TFPIOErrorEvent(type:String, bubbles:Boolean = false, cancelable:Boolean = false, text:String = "", id:int = 0)
		{
		...
		{
			return formatToString("TFPIOErrorEvent", "type", "actualUrl", "status", "bubbles", "cancelable", "eventPhase", "text", "errorID");
		}
