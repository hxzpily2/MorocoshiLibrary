package net.morocoshi.moja3d.shaders.render 
{
	 ...
	 * @author tencho
	 */
	public class DistanceColorFogShader extends MaterialShader 
	{
		...
		public function DistanceColorFogShader(color:uint, distanceNear:Number, distanceFar:Number, densityNear:Number, densityFar:Number, blendMode:String = null) 
		{
			super();
